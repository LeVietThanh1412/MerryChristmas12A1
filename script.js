function createStars() {
  ...
  function createGift() {
    ...
    const messages = [
      '🎁 Chúc bạn một mùa Giáng sinh an lành, luôn mạnh khỏe, vui vẻ, hạnh phúc.',
      '🎄 Tặng bạn nhiều điều tốt lành để bạn mãi là người bạn thân yêu của mình! Merry Christmas',
      '⭐ Một năm nữa đã trôi qua và tôi hy vọng rằng bạn và gia đình sẽ có một Giáng sinh tuyệt vời',
      '🎅 Chúc cho bạn thân yêu của tôi Giáng Sinh này sẽ nhận được nhiều quà và được lời mời đi chơi từ crush nhé.',
      '❄️ Chúc gia đình bạn có một mùa giáng sinh đong đầy niềm vui và hạnh phúc',
      '⛄ Cầu chúc cho bạn nhận được tất cả những gì bạn mong muốn và mơ ước',
    ];
